...
(function() {
    ...
    function _injectToolPostActions(toolId) {
        ...
        container.innerHTML =
            ...
            '</div>' +
            '<div style="background:var(--surface,#fff);border:1px solid var(--border,rgba(0,0,0,0.1));border-radius:8px;padding:10px 14px;display:flex;flex-wrap:wrap;align-items:center;gap:10px">' +
