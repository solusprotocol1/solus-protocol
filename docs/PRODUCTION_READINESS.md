...
4. **CMMC/FedRAMP/IL4 assessment** — required for DoW contracts
...
### Improvements
- [x] **DoW Rebrand** — 44 replacements across 20 files: "DoW" → "DoW", "Department of War" → "Department of War" (DODIC identifiers preserved)
