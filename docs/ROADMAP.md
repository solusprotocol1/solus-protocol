...
- 500+ pre-loaded military platforms across the U.S. Navy (500+ platforms, 37 real defense suppliers, 25 DoD contracts)
- 156+ pre-built record types across Navy, USMC, and USCG (any defense record type supported)
