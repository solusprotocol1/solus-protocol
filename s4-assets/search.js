...
const searchIndex = [
    ...
    { title: 'Audit Readiness & Compliance', tags: 'audit DCMA Inspector General JAGMAN compliance DoW', page: 'Use Cases', url: 'use-cases' },
    ...
    { title: 'Milestone & Decision Gate Verification', tags: 'milestone DoWI 5000.02 MS A B C decision gate', page: 'Use Cases', url: 'use-cases' },
    ...
    { title: 'FAQ — DoW system integration?', tags: 'FAQ 3-M GCSS DPAS REST API Python SDK integrate', page: 'FAQ', url: 'faq' },
    ...
    { title: 'Investor Portal — Market Opportunity', tags: 'investor market opportunity $400B DoW counterfeit $2-3B', page: 'Investors', url: 'investors' },
    ...
    { title: 'ILS Workspace', tags: 'ILS workspace command center gap analysis readiness DMSMS lifecycle warranty ROI action items calendar parts cross-reference', page: 'Demo App', url: 'demo-app' },
    { title: 'Action Items — Cross-Tool Task Queue', tags: 'action items task queue severity critical warning delegation schedule cost', page: 'Demo App', url: 'demo-app' },
    { title: 'Calendar — ILS Program Scheduling', tags: 'calendar schedule events milestones deadlines warranty expiry DMSMS review', page: 'Demo App', url: 'demo-app' },
    { title: 'DMSMS Tracker — Obsolescence Risk', tags: 'DMSMS obsolescence end of life diminishing manufacturing alternate sources', page: 'Demo App', url: 'demo-app' },
    { title: 'Readiness Calculator — Ao & Ai', tags: 'readiness availability Ao Ai MTBF MTTR MLDT RAM MIL-STD-1390', page: 'Demo App', url: 'demo-app' },
    { title: 'Parts Cross-Reference — NSN Lookup', tags: 'parts NSN CAGE cross-reference alternate component lookup', page: 'Demo App', url: 'demo-app' },
    { title: 'ROI Calculator — Return on Investment', tags: 'ROI return investment savings FTE labor reduction analytics', page: 'Demo App', url: 'demo-app' },
    { title: 'Lifecycle Cost Estimator — DoD 5000.73', tags: 'lifecycle cost total ownership sustainment acquisition DMSMS mitigation DoD 5000.73', page: 'Demo App', url: 'demo-app' },
    { title: 'Warranty & Contract Tracker', tags: 'warranty contract OEM CLIN expiration renewal 90-day alert', page: 'Demo App', url: 'demo-app' },
