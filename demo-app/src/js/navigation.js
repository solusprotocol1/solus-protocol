...
function _rewireWalletFlowDetails(sidebarBody) {
    ...
    flowPanel.innerHTML = '<div style="position:relative">'
        + '<div style="position:absolute;top:-4px;right:0;background:linear-gradient(135deg,#00aaff,#c9a84c);padding:3px 12px;border-radius:0 10px 0 8px;font-size:0.62rem;font-weight:700;color:#1d1d1f;letter-spacing:0.5px">LIVE PREVIEW</div>'
